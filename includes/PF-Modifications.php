			...
			<div id="zenododiv" class="postbox">
				...
				<div class="inside">
					...
					<?php
						...
						$tite = esc_html( $title );
					?>
					<label for="zen_source_title"><textarea type="text" id="zen_source_title" rows="5" cols="20" name="zen_source_title"><?php echo $title; ?></textarea><br />&nbsp;<?php _e('Override source title.', 'pf'); ?></label><hr />
					<label for="pf_keywords"><input type="text" id="pf_keywords" name="pf_keywords" value=""/><br />&nbsp;<?php _e('Enter Keywords, semicolon seperated.', 'pf'); ?></label><hr />
					<label for="pf_references"><input type="text" id="pf_references" name="pf_references" value=""/><br />&nbsp;<?php _e('Enter Referance Identifiers, semicolon seperated.', 'pf'); ?></label><hr />
					<label for="zen_item_date"><input type="text" id="zen_item_date" name="zen_item_date" value=""/><br />&nbsp;<?php _e('Enter published date in the format YYYY-MM-DD, if that date is not today.', 'pf'); ?></label><hr />
